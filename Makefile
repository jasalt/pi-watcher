...
BIOME_SCOPE ?= src __tests__ package.json tsconfig.json biome.json knip.json vitest.config.unit.ts vitest.config.integration.ts vitest.config.llm.ts
JSCPD_SCOPE ?= src __tests__
